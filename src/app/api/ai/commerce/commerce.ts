        ...
        content: JSON.stringify(
          isProductReplyTask
            ? {
                expectedSchema: {
                  reply:
                    "short neutral acknowledgement with no product details",
                },
